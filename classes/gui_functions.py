...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        #tweezer stuff
        #self.ui.I1box.valueChanged.connect(self.get_I1value)
        #self.ui.I2box.valueChanged.connect(self.get_I2value)
        #self.ui.I3box.valueChanged.connect(self.get_I3value)
        #self.ui.I4box.valueChanged.connect(self.get_I4value)
        self.ui.applybutton.clicked.connect(self.apply_function)
   

  
    """
    def get_I1value(self):
        self.I1value = self.ui.I1box.value()

    def get_I2value(self):
        self.I2value = self.ui.I2box.value()

    def get_I3value(self):
        self.I3value = self.ui.I3box.value()

    def get_I4value(self):
        self.I4value = self.ui.I4box.value()
    """    
       


    def apply_function(self):
        if self.ui.applybutton.isChecked():
            self.I1value = self.ui.I1box.value()
            self.I2value = self.ui.I2box.value()
            self.I3value = self.ui.I3box.value()
            self.I4value = self.ui.I4box.value()

            self.ui.applybutton.setText("Stop")
    ...
    def update_image(self, frame, robot_list):
        ...
        if self.ui.applybutton.isChecked():
            self.arduino.send(self.I1value, self.I2value, self.I3value, self.I4value)
        else:
            self.arduino.send(0,0,0,0)
